...
import com.demo.driver.AppiumConfig;
    ...
    public AppiumConfig appiumConfig() {
        ...
        if (platform == Platform.ANDROID) {
            return new AppiumConfig(
                    ...
                    resolvePath(get("android.app.path",
                            "sample-apps/android/app/build/outputs/apk/debug/app-debug.apk")),
                    "",
        ...
        return new AppiumConfig(
                ...
                resolvePath(get("ios.app.path",
                        "sample-apps/ios/build/Build/Products/Debug-iphonesimulator/ShopMate.app")),
